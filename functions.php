...
function fabris_set_strings_transtaltion(){
	...
	$strings = [
		...
		'gym'	=>	'Gimnasio',
        'kids_area'	=>  'Área de juegos para niños',
		...
		'party_saloon'	=>	'Salón de fiestas',
		'bbq_area'	=>	'Zona de barbacoa',
		'Park'	=>	'Parque',
		'volleyball_court'	=>	'Cancha de voleibol',
		'picninc_area'	=>	'Área de picnic',
		'beach_club'	=>	'Club de playa',
		'beach_access'	=>	'Acceso a la playa',
		'elevator'	=>	'Elevador',
		'cinema_room'	=>	'Sala de cine',
		'offices'	=>	'Oficinas',
		'multiple_use_room'	=>	'Salón de usos múltiples',
		'coworking'	=>	'Coworking',
		'pet_park'	=>	'Parque para perros',
		'underground_parking'	=>	'Estacionamiento subterráneo',
		'skate_area'	=>	'Pista de patinaje',
		'beauty_saloon'	=>	'Salón de belleza',
		'convenience_store'	=>	'Tienda de conveniencia',
		'coffe_shop'	=>	'Cafetería',
		'restaurant'	=>	'Restaurante',
		'pool_bar'	=>	'Bar en la piscina',
		'24_hour_security'      => 'Seguridad 24 Horas',
		'bar'                   => 'Bar',
		'bbq'                   => 'Asador',
		'parking'               => 'Estacionamiento',
		'club_house'            => 'Casa Club',
		'boat_house'            => 'Casa del barco',
		'boat_dock'             => 'Campo de amarre para botes',
		'deck'                  => 'Cubierta',
		'fence_wall'            => 'Valla/Muro',
		'fire_pits'             => 'Fogatas',
		'fountain'              => 'Fuente',
		'garden'                => 'Jardín',
		'home_theater'          => 'Cine en casa',
		'jacuzzi'               => 'Bañera de hidromasaje/Jacuzzi',
		'kitchen_nook'          => 'Rincón de cocina',
		'service_rooms'         => 'Cuartos de servicio',
		'outdoor_kitchen'       => 'Cocina al aire libre',
		'outdoor_shower'        => 'Ducha al aire libre',
		'palapa'                => 'Palapa',
		'patio'                 => 'Patio',
		'pergola'               => 'Pérgola',
		'pet_area'              => 'Área para mascotas',
		'pool'                  => 'Alberca',
		'pool_heater'           => 'Calentador de Alberca',
		'rooftop_terrace'       => 'Terraza en la azotea',
		'sauna'                 => 'Sauna',
		'second_kitchen'        => 'Segunda cocina',
		'living_room'           => 'Sala de estar',
		'spa'                   => 'Spa',
		'storage_area'          => 'Zona de almacenamiento',
		'storage_building'      => 'Edificio de almacenamiento',
		'terrace'               => 'Terraza',
		'waterfalls'            => 'Cascadas de agua',
